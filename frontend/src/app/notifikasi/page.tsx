...
function iconFor(t: string) {
  switch (t) {
    ...
    case 'OUTBID': return { Ico: AlertTri, cls: 'out' };
    case 'WIN':    return { Ico: Trophy,   cls: 'won' };
...
export default function NotifikasiPage() {
  ...
  const filterMap = {
    all:      () => true,
    bids:     (n: Notification) => n.type === 'BID' || n.type === 'OUTBID',
    auctions: (n: Notification) => n.type === 'WIN' || n.type === 'ENDING',
        ...
        <div>
          ...
          <div className="bm-notif-shell">
            <div style={{ flex: 1 }}>
              ...
              {loading ? (
                <div style={{ padding: 48, textAlign: 'center', color: 'var(--ink-3)' }}>Memuat notifikasi…</div>
              ) : (
                      ...
                      <div key={n.id} className={`bm-notif ${n.unread ? 'unread' : ''}`} onClick={() => toggleRead(n.id)}>
                        ...
                        <div className="bm-notif-body">
                          <div className="bm-notif-title">
                            ...
                            {n.type === 'WIN' && <Badge tone="green">MENANG</Badge>}
                          </div>
            ...
            <aside className="bm-prefs">
              ...
              <div className="bm-prefrow">
                <div className="l"><span className="nm">Email</span><span className="ds">{user?.email || '—'}</span></div>
