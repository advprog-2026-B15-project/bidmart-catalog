            ...
            {user ? (
              <>
                <button className="bm-userbtn" onClick={() => setUserOpen(o => !o)}>
                  <span className="bm-avatar">{user.username.slice(0, 2).toUpperCase()}</span>
                ...
                {userOpen && (
                  <div className="bm-popover" onClick={() => setUserOpen(false)}>
                    <div className="head">
                      <span className="bm-avatar lg">{user.username.slice(0, 2).toUpperCase()}</span>
                      <div>
                    ...
                    <div className="row danger" onClick={handleLogout}><LogOut width={16} height={16}/>Keluar</div>
                  </div>
                )}
              </>
            ) : (
